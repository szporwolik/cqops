...
### Configuration
- **Unified save convention**: Integration, Callbook and Notifications menus now match General — Ctrl+S no longer saves and no longer appears in the help overlay or bottom bar. The in-form **[ Save & Back ]** button (**Enter**/**Space**) is the single save path.
