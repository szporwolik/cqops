...
Também disponível via `pacaur`, `aura` ou `makepkg` manual. PKGBUILD em [aur.archlinux.org/packages/cqops-bin](https://aur.archlinux.org/packages/cqops-bin).
