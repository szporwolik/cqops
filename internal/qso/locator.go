...
// locatorRe validates Maidenhead grid locators: 2/4/6/8/10 chars, standard field ranges.
// 2-char form (e.g. "KO") accepted for WSJT-X compatibility.
var locatorRe = regexp.MustCompile(`^[A-R]{2}([0-9]{2}([A-X]{2}([0-9]{2}([A-X]{2})?)?)?)?$`)
...
// (2, 4, 6, 8, or 10 characters with correct field ranges).
